        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    // For security reasons, it's better not to reveal that the user does not exist
                ...
                if (!isEmailConfirmed)
                {
                    // Email not confirmed, handle accordingly
                    // For security reasons, it's better not to reveal that the email is not confirmed
                    return View("ForgotPasswordConfirmation");
                }
